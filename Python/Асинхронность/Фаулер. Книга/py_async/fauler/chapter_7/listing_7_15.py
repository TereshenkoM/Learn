...
class ThreadingEventLoop(Thread):
    ...
    def run(self):
        # Вызов run_forever() блокирует текущий поток до тех пор, пока цикл не будет остановлен.
        # Для неблокирующего выполнения асинхронного кода параллельно с другим синхронным кодом
